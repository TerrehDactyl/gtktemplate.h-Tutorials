...
GtkWidget *window = createwindow("main window",GTK_WIN_POS_CENTER); //popups can be done with createwindow as well 
GtkWidget *popup = create_custom_window("popup", GTK_WINDOW_TOPLEVEL, GTK_WIN_POS_CENTER, 480,640);
